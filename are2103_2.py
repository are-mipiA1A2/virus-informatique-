...
def population():
    ...
    #Plus le taux de protection est haut moins le temps de desinfection est eleve.
        ...
        pop[i] = [infection, protection, Tdesinfection, set(), serveurs_locaux, serveurs_globaux]
    return pop
...
def s_locaux():
    ...
    for i in range(1, NSL+1):
        ...
        while m > 0:
            ...
            SG[sg][4].add("s"+ str(i))
            m -= 1
        DR["s"+str(i)] = [False, protection, Tdesinfection, Ea, set(), Esg]
        Ea = set()
        Esg = set()
